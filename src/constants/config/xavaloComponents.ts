...
export interface xavaloComponent {
  name: string;
  title: string;
  url: string;
...
export const components: xavaloComponent[] = [
  {
    name: 'player',
    title: 'Người chơi',
    url: `/xavalor-dashboard/#protein`,
    categories: ['charts'],
