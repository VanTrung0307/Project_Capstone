...
import { FPTHCMScreeningsChart } from '../FPTHCMScreeningsChart/FPTHCMScreeningsChart';
import { FPTHCMScreeningsHeader } from '../FPTHCMScreeningsHeader/FPTHCMScreeningsHeader';
import * as S from './FPTHCMScreeningsCard.styles';
...
export const FPTHCMScreeningsCard: React.FC = () => {
  ...
  return (
    <S.FPTHCMScreeningsCard
      title={<FPTHCMScreeningsHeader currentStatistics={currentStatistics} setCurrentStatistics={setCurrentStatistics} />}
      padding={0}
    >
      {/* <ScreeningsFriends
      ...
      /> */}
      <FPTHCMScreeningsChart firstUser={getUserStatistic(true)} secondUser={getUserStatistic(false)} />
    </S.FPTHCMScreeningsCard>
  );
};
