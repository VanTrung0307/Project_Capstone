...
import { CurrentStatisticsState } from '../FPTHCMScreeningsCard/FPTHCMScreeningsCard';
...
export const FPTHCMScreeningsHeader: React.FC<ScreeningsHeaderProps> = ({ currentStatistics, setCurrentStatistics }) => {
  const { t } = useTranslation();

  return (
    <Row gutter={[0, { xs: 15, sm: 15, md: 20 }]} align="middle">
      <Col xs={24} xl={12}>
        {t('Bảng xếp hạng người chơi')}
      </Col>
